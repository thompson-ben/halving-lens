...
const STATUS: Record<string, { label: string; color: string; note: string }> = {
  ...
  modelled: { label: "Modelled", color: "#a78bfa", note: "Calculated from documented, versioned assumptions applied to observed network data (e.g. Estimated Mining Cost). Displayed in the product with the ESTIMATED badge — historical context, never an exact observable value." },
    ...
    <div className="max-w-3xl mx-auto space-y-12">
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <Category color="#8c919c" title="Modelled estimates" body="On-chain metrics we cannot yet source live are modelled for illustration and kept out of the live product — clearly marked, never shown as live. One clearly-marked exception is published: Estimated Mining Cost, a modelled electricity-cost estimate with documented, versioned assumptions, always displayed with the ESTIMATED badge and a visible methodology." />
