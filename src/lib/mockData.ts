...
export const mockCompetitors = [
  { platform: "instagram", handle: "supercars_oftheworld", url: "https://instagram.com/supercars_oftheworld", followers: 3_200_000, notes: "Largest aggregator. Posts 6–8×/day.", active: true },
  { platform: "instagram", handle: "carlifestyle", url: "https://instagram.com/carlifestyle", followers: 12_500_000, notes: "Premium curation. Heavy on launches.", active: true },
  { platform: "instagram", handle: "italian_supercars", url: "https://instagram.com/italian_supercars", followers: 1_800_000, notes: "Ferrari / Lambo focus.", active: true },
  { platform: "tiktok", handle: "supercarblondie", url: "https://tiktok.com/@supercarblondie", followers: 18_000_000, notes: "Video-first; launch coverage.", active: true },
];
