...
export const WEEKLIES: WeeklyReport[] = [
  {
    ...
    "executiveSummary": [
      ...
      "Sentiment sits in extreme fear (Fear & Greed 11).",
    ...
    "longView": "In the arc of the current cycle, this week reads as deep value territory — day 803 from the halving, with the cycle running slower and flatter than its predecessors. Zoomed out, the signal is less about any single week and more about how persistently this cycle has diverged from the template that came before it.",
